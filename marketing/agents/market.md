...
**Responsável por:** Coletar dados de mercado, tendências, comportamento de consumo, paisagem competitiva e atualizar `marketing/skills/strategy/market-context.md` automaticamente.

**Quando roda:** Diariamente às 23h BRT (00h UTC+1) — após Insights Agent
**Entrada:** MCPs de trend data + APIs externas
**Saída:** Arquivo atualizado `marketing/skills/strategy/market-context.md` + commit no GitHub
