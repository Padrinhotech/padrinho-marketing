...
## Contexto Cultural & Tendências

> **Tendências estruturais** (Sober Curious, IA & bem-estar, bebidas sem álcool, saúde mental mainstream) e **demanda de busca** (Google Trends) são canônicas em **`KNOW_TrendRadar.md`** § Tendências Estruturais — não duplicar aqui. Este arquivo cobre **mercado** (consumo, escala, geografia) e **concorrentes de produto**.
