...
- **Formato e artefato de IG:** marcar cada post como **Carousel** ou **Reels**. Na Tactic, todo post gera `INSTA_ReelsQuestions` (3 a 5 perguntas que renderiam um Reels); o artefato principal segue o formato, Carousel gera `INSTA_Carousel` e Reels gera `INSTA_ReelsScript`.
