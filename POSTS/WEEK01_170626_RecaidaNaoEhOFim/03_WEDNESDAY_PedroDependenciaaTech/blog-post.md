...
Você percebeu algo? Uma inquietação? Um impulso de voltar? Uma sensação de que você está perdendo algo?
...
Os engenheiros de apps conhecem esse sistema. Eles o projetaram para explorar isso.

**Como funciona:**
1. Você abre o app → libera dopamina
2. Seu cérebro registra: "Quando você abre o app, dopamina"
3. Seu cérebro quer dopamina novamente
...
- Dopamina
- Padrões intermitentes de recompensa
- Hábito neurológico
- Vício comportamental

Se você consegue entender como seu cérebro funciona com o celular, você consegue entender como ele funciona com o álcool.
...
3. **Aja:** Comece pequeno. 30 minutos. Depois 1 hora. Reconheça os padrões.

---

**Você consegue largar o celular por uma hora? O que você sente?**
