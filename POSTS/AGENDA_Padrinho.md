---
title: AGENDA Padrinho — Temas H2 2026
version: 1.0
...
Calendário editorial centralizado. **Gerador de verdade única** para planejamento estratégico.

Estrutura: data | tema | pilar editorial | persona primária | canais | status
...
|--------|------|------|-------|---------|--------|-------|
| 32 | 05–11 Aug | Ser funcional e ainda ter uma relação complicada com o álcool | Desmascaramento | Rosa | Planejado | Quebra mito principal |
| 33 | 12–18 Aug | Medo de perder a diversão: por que isso não acontece | Acolhimento | Rosa | Planejado | Resistência comum |
| 34 | 19–25 Aug | O ciclo da codependência (e por que informação muda tudo) | Empoderamento | Caio | Planejado | Familiar como amplificador |
| 35 | 26–01 Sep | Quando o álcool vira escape: sinais que você pode estar ignorando | Reconhecimento | Pedro | Planejado | Isolamento + risco |
| 36 | 02–08 Sep | Agosto recap: métricas de esperança (dados de quem mudou) | Reingresso | All | Planejado | Community wins |

### SETEMBRO–OUTUBRO–NOVEMBRO (Semanas 37–48) — TBD

> Planejar com dados de Apify (competitor content) + feedback de engagement Julho–Agosto
> Slots reservados para temas emergentes, campanhas sazonais (Outubro Rosa), e eventos Padrinho

### DEZEMBRO (Semanas 49–52) — Especial

| Semana | Tema | Pilar | Persona | Notas |
|--------|------|-------|---------|-------|
| 50 | Retrospectiva 2026: quem começou, continua, transformou | Reingresso | All | Comunidade |
| 51 | Virada de ano: sobriedade como primeiro presente | Acolhimento | All | Esperança |
...
### Para AGENT_Strategy
1. Leia a linha da semana
2. Crie `POSTS/DDMMYYYY_Tema/POST_Overview.md`
3. Inclua: pergunta central, pilar, persona, refs de KNOW_

### Para AGENT_Tactic
1. Leia POST_Overview
2. Crie 6 arquivos de TEXTO (Blog, News, IG Captions, Podcast, WhatsApp, LinkedIn)
3. Cada um otimizado para o canal

### Para AGENT_Operational
1. Valida os 6 textos
2. Commit para GitHub
3. Sinaliza para Figma

### Para AGENT_Figma
1. Lê POST_Overview + instagram-captions.md
2. Cria imagens (Camada 2)
3. Exporta para assets/images/

---

## Atualizar Esta Agenda

- **Quinzenalmente:** Revisar ajustes baseado em engagement + feedback comunidade
- **Mensalmente:** Refinar temas Sep–Dez com dados de competitor scraping (Apify)
- **Semanalmente:** Confirmar tema da semana com Bill (content lead) antes de STRATEGY iniciar
