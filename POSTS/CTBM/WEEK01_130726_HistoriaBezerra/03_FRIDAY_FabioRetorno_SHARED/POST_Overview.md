...
## Os 2 cortes (1 conteúdo, 2 vozes)

### 🟩 Corte CTBM — @ctbezerrademenezes
- **Ângulo:** *“Um paciente nosso, há 16 anos, hoje é nosso parceiro.”* — orgulho institucional + a prova mais forte possível dos 50 anos: **gente que recomeçou aqui**.
...
**CTA compartilhado:** **marcação cruzada obrigatória** (@padrinho.app ↔ @ctbezerrademenezes) — meta nº1: **somar audiências**.

**Tom:** Verdadeiro, digno, esperançoso — **sem romantizar nem dramatizar** a dependência (Lei: nunca glamourizar a dor). **Co-branding dosado:** o **Fábio (a pessoa e a história)** é protagonista.

**Consentimento:** história própria do Fábio = **consentimento direto** — mas é disclosure pessoal forte; **enquadramento e nível de detalhe definidos por ele**.

**Success Metric (chave do Fluxo C):** **cross-follows**, alcance somado, saves/shares, comentários de identificação/acolhimento.

> **Espelhamento:** governa a versão do Padrinho em `POSTS/Padrinho/WEEK04_130726_HistoriaDoFabio/`. Só os cortes/legendas (Tactic) diferem.
