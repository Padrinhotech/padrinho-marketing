...
pilar: A Vida Depois
fase: "Futuro (a parceria + a tecnologia)"
date: 2026-07-18
duration: "~40–50s"
shared: true
mirror: "POSTS/Padrinho/WEEK04_130726_HistoriaDoFabio/"
status: "Draft Tactic (text layer) — fatos a confirmar com os times · App = continuidade, nunca anúncio (Lei §8)"
---

# Reels — "O cuidado que continua depois da alta"
...
### Beat 1 — Hook (0–5s)
- **Texto na tela:** "O tratamento mais difícil termina no dia da alta. O cuidado, não."
- **Narração:** "O tratamento mais difícil termina no dia da alta. Mas o cuidado não pode terminar ali. E é exatamente aí que essa parceria começa."

### Beat 2 — O problema (5–18s)
- **Texto na tela:** "É no 'depois' que muita gente recai — sozinha."
- **Narração:** "Quando o suporte intensivo acaba, vem a parte mais silenciosa: voltar pra rotina. É nesse 'depois', sozinho, que mora o maior risco de recaída."
...
- **Narração:** "Recomeçar é começar. Continuar é o que faz durar. E ninguém precisa continuar sozinho."
...
➡️ Entenda como funciona o "depois" em @padrinho.app. Segue os dois.

\#bezerrademenezes #avidadepois #recomeço #cuidadocontinuo #padrinho

### 🟦 Corte Padrinho — @padrinho.app
**Ângulo:** "a recuperação não acaba na alta — e ninguém deveria seguir sozinho." Padrinho como o "depois". Bill = presença, não anúncio.

**Legenda:**
A recuperação não acaba na alta. Na real, é aí que ela fica mais desafiadora — porque o suporte intenso acaba e a vida cobra de volta.
...
➡️ Segue @ctbezerrademenezes pra conhecer onde tudo começa.

\#padrinho #recuperação #avidadepois #recomeço #bezerrademenezes

---

## CTA compartilhado
**Marcação cruzada obrigatória** (@padrinho.app ↔ @ctbezerrademenezes). Sinais-chave: cross-follows, alcance somado, DM/cliques (intenção).

## Reshare WhatsApp / IG (curto)
"O tratamento mais difícil termina na alta. O cuidado, não. Bezerra (onde a vida recomeça) + Padrinho (que caminha depois): o cuidado não para na porta de saída. 💚 (vídeo novo)"
